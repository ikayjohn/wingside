...
-- ============================================================================
-- This migration fixes issues with the get_user_points_details function
-- when users have no points history or incomplete profile data
-- ============================================================================
...
'Returns comprehensive points information for a user including totals and recent transaction history.
Handles edge cases for users with no points history. Admin only.';
