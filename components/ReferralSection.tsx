  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[3fr_5fr_2fr] gap-6 items-end">
          <div className="flex flex-col min-w-0">
            ...
            <div className="flex h-[46px]">
              ...
              <button
                ...
                className="px-4 bg-yellow-400 text-black rounded-r-lg hover:bg-yellow-500 font-medium transition-colors text-sm whitespace-nowrap"
              >
                {copiedType === 'code' ? '✓' : 'Copy'}
              </button>
            </div>
          </div>

          <div className="flex flex-col min-w-0">
            <label className="text-sm text-gray-600 mb-2 whitespace-nowrap">Your referral link</label>
            <div className="flex h-[46px]">
              <input
                type="text"
                ...
                className="flex-1 px-4 border border-gray-300 rounded-l-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-yellow-400 text-sm min-w-0"
              />
              <button
                onClick={() => copyToClipboard(getReferralUrl(), 'link')}
                className="px-4 bg-yellow-400 text-black rounded-r-lg hover:bg-yellow-500 font-medium transition-colors text-sm whitespace-nowrap"
              >
                {copiedType === 'link' ? '✓' : 'Copy'}
              </button>
            </div>
          </div>

          <div className="flex flex-col">
            <label className="text-sm text-transparent mb-2 hidden md:block select-none">Share</label>
            <button
              onClick={() => setShowShareModal(true)}
              className="w-full h-[46px] bg-black text-white rounded-lg hover:bg-gray-800 font-medium transition-colors flex items-center justify-center"
            >
              Share Referral
            </button>
          </div>
          ...
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { method: 'copy_link' as const, label: 'Copy Link', icon: <LinkIcon className="w-6 h-6 text-black" /> },
                  { method: 'whatsapp' as const, label: 'WhatsApp', icon: <WhatsAppIcon /> },
                  { method: 'email' as const, label: 'Email', icon: <Mail className="w-6 h-6 text-black" /> },
                  { method: 'twitter' as const, label: 'X (Twitter)', icon: <XIcon /> },
                  { method: 'facebook' as const, label: 'Facebook', icon: <FacebookIcon /> },
