...
export const rolePermissions: Record<UserRole, RolePermissions> = {
  ...
  csr: {
    dashboard: { level: 'none' },
    analytics: { level: 'none' },
    orders: { level: 'edit', description: 'View, update status, and print orders' },
    products: { level: 'none' },
    categories: { level: 'none' },
    flavors: { level: 'none' },
    delivery_areas: { level: 'none' },
    ...
    wingside_cards: { level: 'edit', description: 'Manage Wingside Cards for customers' },
  ...
  // DELIVERY - Delivery operations only
  delivery: {
    dashboard: { level: 'none' },
    analytics: { level: 'none' },
    orders: { level: 'edit', description: 'Update delivery status (out_for_delivery → delivered)' },
    products: { level: 'none' },
    categories: { level: 'none' },
    flavors: { level: 'none' },
    delivery_areas: { level: 'view', description: 'View delivery zones' },
    promo_codes: { level: 'none' },
    customers: { level: 'none' },
    gift_cards: { level: 'none' },
    wingside_cards: { level: 'none' },
    ...
    job_positions: { level: 'none' },
    job_applications: { level: 'none' },
    stores: { level: 'view', description: 'View store/pickup locations' },
    wingpost_locations: { level: 'view', description: 'View pickup locations' },
    contact_submissions: { level: 'none' },
    social_verifications: { level: 'none' },
    hero_slides: { level: 'none' },
    users: { level: 'none' },
  ...
  sales_marketing: {
    ...
    crm_analytics: { level: 'full', description: 'Customer relationship analytics' },
    events: { level: 'full', description: 'Create and manage events' },
    blog: { level: 'full', description: 'Manage blog content' },
    sports_events: { level: 'full', description: 'Manage sports events' },
