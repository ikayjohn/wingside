            ...
            {(userData.current_streak ?? 0) > 0 ? (
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-1">
                  {(userData.current_streak ?? 0) >= 7 ? '500 Points Earned!' : `Day ${userData.current_streak ?? 0} of 7`}
                </h3>
                <p className="text-gray-600 text-sm">
                  {getStreakMessage(userData.current_streak ?? 0)}
                </p>
              </div>
                  ...
                  <div key={day} className="flex-1 max-w-[48px] flex flex-col items-center gap-2">
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center ${
                        (userData.current_streak ?? 0) >= day
                          ? ''
                          : 'bg-white border-2 border-gray-200'
                      }`}
                      style={(userData.current_streak ?? 0) >= day ? { backgroundColor: '#F9CB0C' } : {}}
                    >
                      {(userData.current_streak ?? 0) >= day ? (
