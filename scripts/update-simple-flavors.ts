/**
 * Update existing products with simple_flavors and flavor_label
 *
 ...
 *
 * Then run: npx tsx scripts/update-simple-flavors.ts
 */
...
async function main() {
  console.log('🚀 Starting simple flavors update...\n')
