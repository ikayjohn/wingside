  ...
  embedlyClient = {
    getCountries: async () => {
      const response = await fetch('https://waas-staging.embedly.ng/api/v1/utilities/countries/get', {
        headers: { 'x-api-key': 'BSK-sqg0f3hCF3sC2KGtNBVsfxbOFFaiOgCEraaCYmg6G0EsqUQ9ihAbeIE2FkAvFlBtIv4kecDVsy4H' }
      });
    ...
    createCustomer: async (customerData) => {
      const response = await fetch('https://waas-staging.embedly.ng/api/v1/customers/add', {
        ...
        headers: {
          ...
          'x-api-key': 'BSK-sqg0f3hCF3sC2KGtNBVsfxbOFFaiOgCEraaCYmg6G0EsqUQ9ihAbeIE2FkAvFlBtIv4kecDVsy4H'
        },
